...
Participants' age
```{r subject anova age, echo=FALSE, warning=FALSE, paged.print=FALSE}
...
summary(p_age)
LSD.test(p_age, "maingroup", group = FALSE)$comparison
```


Participants' AoASL
```{r subject anova aoasl, echo=FALSE, warning=FALSE, paged.print=FALSE}
# AoASL ANOVA
p_aoasl <- aov(aoasl ~ maingroup, data = p_anovas)
summary(p_aoasl)
LSD.test(p_aoasl, "maingroup", group = FALSE)$comparison
```

Participants' Sign Yrs
```{r subject anova signyrs, echo=FALSE, warning=FALSE, paged.print=FALSE}
# Signyrs ANOVA
p_signyrs <- aov(signyrs ~ maingroup, data = p_anovas)
summary(p_signyrs)
LSD.test(p_signyrs, "maingroup", group = FALSE)$comparison
```

Participants' Self-Rating
```{r subject anova selfrate, echo=FALSE, warning=FALSE, paged.print=FALSE}
# Selfrate ANOVA
p_selfrate <- aov(selfrate ~ maingroup, data = p_anovas)
summary(p_selfrate)
LSD.test(p_selfrate, "maingroup", group = FALSE)$comparison
```
...
1. One with 3 AOIs that show up at all on the **error bar chart** (Eyes, Mouth, Neck)

Each ANOVA will be accompanied by LSDs for Group and AOI if significant. 

Below is for all 5 top AOIs. 

```{r big anova aoi5, echo=FALSE, results="markup"}
# First, we've got to set up the dataset. Define the 5 AOIs
...
big_aov_aoi5 <- aoi5_data %>%
  gather(aoi, percent, eyes:upperchest) %>%
  aov(percent ~ maingroup * direction * aoi, data = .)

summary(big_aov_aoi5)

big_aov_aoi5_lsd <- LSD.test(big_aov_aoi5, "aoi", group = FALSE)
big_aov_aoi5_lsd$comparison
```

And now the big ANOVA for just Eyes, Mouth, and Neck. 
```{r big anova aoi3, echo=FALSE, results="markup"}
# Limit to eyes mouth neck
big_aov_aoi3 <- aoi5_data %>%
  select(-upperchest, -forehead) %>%
...
```{r forehead anova1, echo=FALSE, results="markup"}
# forehead ANOVA 1
forehead_aov1 <- aov(forehead ~ maingroup * direction, data = aoi5_data)
summary(forehead_aov1)
# forehead_lsd1 <- LSD.test(forehead_aov1, "maingroup", group = FALSE)
# forehead_lsd1$comparison
```

2. ANOVA with factor MainGroup, for Forward only.

```{r forehead anova2, echo=FALSE, results="markup"}
# forehead ANOVA 2
forehead_aov2 <- aov(forehead ~ maingroup, data = filter(aoi5_data, direction == "forward"))
summary(forehead_aov2)
# forehead_lsd2 <- LSD.test(forehead_aov2, "maingroup", group = FALSE)
# forehead_lsd2$comparison
```

3. ANOVA with factor MainGroup, for Reverse only. 

```{r forehead anova3, echo=FALSE, results="markup"}
# forehead ANOVA 3
forehead_aov3 <- aov(forehead ~ maingroup, data = filter(aoi5_data, direction == "reversed"))
summary(forehead_aov3)
# forehead_lsd3 <- LSD.test(forehead_aov3, "maingroup", group = FALSE)
# forehead_lsd3$comparison
```

4. ANCOVA with factor Direction, and covariate AoASL and Age.

```{r forehead anova4, echo=FALSE, results="markup"}
# forehead ANOVA 4
forehead_aov4 <- aov(forehead ~ direction * aoasl * age, data = aoi5_data)
summary(forehead_aov4)
```

5. Regression with variables Age and AoASL, for Forward only

```{r forehead anova5, echo=FALSE, results="markup"}
# forehead ANOVA 5
forehead_aov5 <- lm(forehead ~ aoasl * age, data = filter(aoi5_data, direction == "forward"))
summary(forehead_aov5)
```

6. Regression with variables Age and AoASL, for Reverse only

```{r forehead anova6, echo=FALSE, results="markup"}
# forehead ANOVA 6
forehead_aov6 <- lm(forehead ~ aoasl * age, data = filter(aoi5_data, direction == "reversed"))
summary(forehead_aov6)
```
...
# eyes ANCOVA 1
eyes_aov1 <- aov(eyes ~ maingroup * direction, data = aoi5_data)
summary(eyes_aov1)
...
# eyes ANOVA 2
eyes_aov2 <- aov(eyes ~ maingroup, data = filter(aoi5_data, direction == "forward"))
summary(eyes_aov2)
...
# eyes ANOVA 3
eyes_aov3 <- aov(eyes ~ maingroup, data = filter(aoi5_data, direction == "reversed"))
summary(eyes_aov3)
...
# eyes ANOVA 4
eyes_aov4 <- aov(eyes ~ direction * aoasl * age, data = aoi5_data)
summary(eyes_aov4)
```
...
# eyes ANOVA 5
eyes_aov5 <- lm(eyes ~ aoasl * age, data = filter(aoi5_data, direction == "forward"))
summary(eyes_aov5)
```
...
# eyes ANOVA 6
eyes_aov6 <- lm(eyes ~ aoasl * age, data = filter(aoi5_data, direction == "reversed"))
summary(eyes_aov6)
```
...
# mouth ANCOVA 1
mouth_aov1 <- aov(mouth ~ maingroup * direction, data = aoi5_data)
summary(mouth_aov1)
...
# mouth ANOVA 2
mouth_aov2 <- aov(mouth ~ maingroup, data = filter(aoi5_data, direction == "forward"))
summary(mouth_aov2)
...
# mouth ANOVA 3
mouth_aov3 <- aov(mouth ~ maingroup, data = filter(aoi5_data, direction == "reversed"))
summary(mouth_aov3)
...
# mouth ANOVA 4
mouth_aov4 <- aov(mouth ~ direction * aoasl * age, data = aoi5_data)
summary(mouth_aov4)
```
...
# mouth ANOVA 5
mouth_aov5 <- lm(mouth ~ aoasl * age, data = filter(aoi5_data, direction == "forward"))
summary(mouth_aov5)
```
...
# mouth ANOVA 6
mouth_aov6 <- lm(mouth ~ aoasl * age, data = filter(aoi5_data, direction == "reversed"))
summary(mouth_aov6)
```
...
# neck ANCOVA 1
neck_aov1 <- aov(neck ~ maingroup * direction, data = aoi5_data)
summary(neck_aov1)
...
# neck ANOVA 2
neck_aov2 <- aov(neck ~ maingroup, data = filter(aoi5_data, direction == "forward"))
summary(neck_aov2)
...
# neck ANOVA 3
neck_aov3 <- aov(neck ~ maingroup, data = filter(aoi5_data, direction == "reversed"))
summary(neck_aov3)
...
# neck ANOVA 4
neck_aov4 <- aov(neck ~ direction * aoasl * age, data = aoi5_data)
summary(neck_aov4)
```
...
# neck ANOVA 5
neck_aov5 <- lm(neck ~ aoasl * age, data = filter(aoi5_data, direction == "forward"))
summary(neck_aov5)
```
...
# neck ANOVA 6
neck_aov6 <- lm(neck ~ aoasl * age, data = filter(aoi5_data, direction == "reversed"))
summary(neck_aov6)
```
...
```{r upperchest anova1, echo=FALSE, results = 'markup'}

# upperchest ANCOVA 1
upperchest_aov1 <- aov(upperchest ~ maingroup * direction, data = aoi5_data)
summary(upperchest_aov1)
upperchest_lsd1 <- LSD.test(upperchest_aov1, "maingroup", group = FALSE)
upperchest_lsd1$comparison
```

2. ANOVA with factor MainGroup, for Forward only.

```{r upperchest anova2, echo=FALSE, results = 'markup'}
# upperchest ANOVA 2
upperchest_aov2 <- aov(upperchest ~ maingroup, data = filter(aoi5_data, direction == "forward"))
summary(upperchest_aov2)
# upperchest_lsd2 <- LSD.test(upperchest_aov2, "maingroup", group = FALSE)
# upperchest_lsd2$comparison
```

3. ANOVA with factor MainGroup, for Reverse only. 

```{r upperchest anova3, echo=FALSE, results = 'markup'}
# upperchest ANOVA 3
upperchest_aov3 <- aov(upperchest ~ maingroup, data = filter(aoi5_data, direction == "reversed"))
summary(upperchest_aov3)
upperchest_lsd3 <- LSD.test(upperchest_aov3, "maingroup", group = FALSE)
upperchest_lsd3$comparison
```

4. ANCOVA with factor Direction, and covariate AoASL and Age.

```{r upperchest anova4, echo=FALSE, results = 'markup'}
# upperchest ANOVA 4
upperchest_aov4 <- aov(upperchest ~ direction * aoasl * age, data = aoi5_data)
summary(upperchest_aov4)
```

5. Regression with variables Age and AoASL, for Forward only

```{r upperchest anova5, echo=FALSE, results = 'markup'}
# upperchest ANOVA 5
upperchest_aov5 <- lm(upperchest ~ aoasl * age, data = filter(aoi5_data, direction == "forward"))
summary(upperchest_aov5)
```

6. Regression with variables Age and AoASL, for Reverse only

```{r upperchest anova6, echo=FALSE, results = 'markup'}
# upperchest ANOVA 6
upperchest_aov6 <- lm(upperchest ~ aoasl * age, data = filter(aoi5_data, direction == "reversed"))
summary(upperchest_aov6)
```
...
```{r moutheye bar chart, message=FALSE, warning=FALSE}
...
```{r moutheye anova 1, echo=FALSE, results = 'markup'}
# moutheye ANCOVA 1
moutheye_aov1 <- aov(moutheye ~ maingroup * direction, data = fc_data)
summary(moutheye_aov1)
moutheye_lsd1 <- LSD.test(moutheye_aov1, "maingroup", group = FALSE)
moutheye_lsd1$comparison
```

2. ANOVA with factor MainGroup, for Forward only.

```{r moutheye anova2, echo=FALSE, results = 'markup'}
# moutheye ANOVA 2
moutheye_aov2 <- aov(moutheye ~ maingroup, data = filter(fc_data, direction == "forward"))
summary(moutheye_aov2)
# moutheye_lsd2 <- LSD.test(moutheye_aov2, "maingroup", group = FALSE)
# moutheye_lsd2$comparison
```

3. ANOVA with factor MainGroup, for Reverse only. 

```{r moutheye anova3, echo=FALSE, results = 'markup'}
# moutheye ANOVA 3
moutheye_aov3 <- aov(moutheye ~ maingroup, data = filter(fc_data, direction == "reversed"))
summary(moutheye_aov3)
# moutheye_lsd3 <- LSD.test(moutheye_aov3, "maingroup", group = FALSE)
# moutheye_lsd3$comparison
```

4. ANCOVA with factor Direction, and covariate AoASL and Age.

```{r moutheye anova4, echo=FALSE, results = 'markup'}
# moutheye ANOVA 4
moutheye_aov4 <- aov(moutheye ~ direction * aoasl * age, data = fc_data)
summary(moutheye_aov4)
```

5. Regression with variables Age and AoASL, for Forward only

```{r moutheye anova5, echo=FALSE, results = 'markup'}
# moutheye ANOVA 5
moutheye_aov5 <- lm(moutheye ~ aoasl * age, data = filter(fc_data, direction == "forward"))
summary(moutheye_aov5)
```

6. Regression with variables Age and AoASL, for Reverse only

```{r moutheye anova6, echo=FALSE, results = 'markup'}
# moutheye ANOVA 6
moutheye_aov6 <- lm(moutheye ~ aoasl * age, data = filter(fc_data, direction == "reversed"))
summary(moutheye_aov6)
```
