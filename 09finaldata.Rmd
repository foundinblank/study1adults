...
# Gist ANOVA 4
gist_aov4 <- aov(gist ~ hearing * direction * aoasl * age, data = participant_data)
summary(gist_aov4)
```

5. ANCOVA with factor Hearing and covariates Age and AoASL, for Forward only

```{r gist anova5, echo=FALSE, results = 'markup'}
# Gist ANOVA 5
gist_aov5 <- aov(gist ~ hearing * aoasl * age, data = filter(participant_data, direction == "forward"))
summary(gist_aov5)
```
...
# Gist ANOVA 6
gist_aov6 <- aov(gist ~ hearing * aoasl * age, data = filter(participant_data, direction == "reversed"))
summary(gist_aov6)
```
...
acc_aov4 <- aov(acc ~ hearing * direction * aoasl * age, data = participant_data)
summary(acc_aov4)
```
...
acc_aov5 <- aov(acc ~ hearing * aoasl * age, data = filter(participant_data, direction == "forward"))
summary(acc_aov5)
```
...
acc_aov6 <- aov(acc ~ hearing * aoasl * age, data = filter(participant_data, direction == "reversed"))
summary(acc_aov6)
```
...
# forehead ANOVA 4
forehead_aov4 <- aov(forehead ~ hearing * direction * aoasl * age, data = aoi5_data)
...
# forehead ANOVA 5
forehead_aov5 <- aov(forehead ~ hearing * aoasl * age, data = filter(aoi5_data, direction == "forward"))
...
# forehead ANOVA 6
forehead_aov6 <- aov(forehead ~ hearing * aoasl * age, data = filter(aoi5_data, direction == "reversed"))
...
# eyes ANOVA 4
eyes_aov4 <- aov(eyes ~ hearing * direction * aoasl * age, data = aoi5_data)
summary(eyes_aov4)
```
...
# eyes ANOVA 5
eyes_aov5 <- aov(eyes ~ hearing * aoasl * age, data = filter(aoi5_data, direction == "forward"))
summary(eyes_aov5)
```
...
# eyes ANOVA 6
eyes_aov6 <- aov(eyes ~ hearing * aoasl * age, data = filter(aoi5_data, direction == "reversed"))
summary(eyes_aov6)
```
...
# mouth ANOVA 4
mouth_aov4 <- aov(mouth ~ hearing * direction * aoasl * age, data = aoi5_data)
summary(mouth_aov4)
```
...
# mouth ANOVA 5
mouth_aov5 <- aov(mouth ~ hearing * aoasl * age, data = filter(aoi5_data, direction == "forward"))
summary(mouth_aov5)
```
...
# mouth ANOVA 6
mouth_aov6 <- aov(mouth ~ hearing * aoasl * age, data = filter(aoi5_data, direction == "reversed"))
summary(mouth_aov6)
```
...
# neck ANOVA 4
neck_aov4 <- aov(neck ~ hearing * direction * aoasl * age, data = aoi5_data)
summary(neck_aov4)
```
...
# neck ANOVA 5
neck_aov5 <- aov(neck ~ hearing * aoasl * age, data = filter(aoi5_data, direction == "forward"))
summary(neck_aov5)
```
...
# neck ANOVA 6
neck_aov6 <- aov(neck ~ hearing * aoasl * age, data = filter(aoi5_data, direction == "reversed"))
summary(neck_aov6)
```
...
# upperchest ANOVA 4
upperchest_aov4 <- aov(upperchest ~ hearing * direction * aoasl * age, data = aoi5_data)
...
# upperchest ANOVA 5
upperchest_aov5 <- aov(upperchest ~ hearing * aoasl * age, data = filter(aoi5_data, direction == "forward"))
...
# upperchest ANOVA 6
upperchest_aov6 <- aov(upperchest ~ hearing * aoasl * age, data = filter(aoi5_data, direction == "reversed"))
...
```{r recalculate facechest, echo=FALSE, results = 'markup'}
...
```{r facechest anova 1, echo=FALSE, results = 'markup'}
...
# facechest ANOVA 4
facechest_aov4 <- aov(facechest ~ hearing * direction * aoasl * age, data = fc_data)
...
# facechest ANOVA 5
facechest_aov5 <- aov(facechest ~ hearing * aoasl * age, data = filter(fc_data, direction == "forward"))
...
# facechest ANOVA 6
facechest_aov6 <- aov(facechest ~ hearing * aoasl * age, data = filter(fc_data, direction == "reversed"))
...
# moutheye ANOVA 4
moutheye_aov4 <- aov(moutheye ~ hearing * direction * aoasl * age, data = fc_data)
...
# moutheye ANOVA 5
moutheye_aov5 <- aov(moutheye ~ hearing * aoasl * age, data = filter(fc_data, direction == "forward"))
...
# moutheye ANOVA 6
moutheye_aov6 <- aov(moutheye ~ hearing * aoasl * age, data = filter(fc_data, direction == "reversed"))
