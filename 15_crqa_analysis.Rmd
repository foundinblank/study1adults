...
# Eye Gaze & Hand Position Time-Series Plot
...
# 4-panel plot of averaged y-position for each group
# averaged_y %>%
#   ggplot() +
...
# All 4 groups plotted on same plot
# averaged_y %>%
#   ggplot() +
...
# Just Deaf Early vs. Hearing Novice
p1 <- y_averaged %>%
